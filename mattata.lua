...
local api = require('mattata-api.core').configure(configuration.bot_token)
local tools = require('mattata-api.tools')
local plugin_list = {}
        ...
        if res then
            for _, update in ipairs(res.result) do
                ...
                elseif update.callback_query then
                    if update.callback_query.message.reply_to_message then
